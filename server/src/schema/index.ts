...
import { AssetDevelopHistoryTable } from 'src/schema/tables/asset-develop-history.table';
...
export interface DB {
  ...
  asset_develop_history: AssetDevelopHistoryTable;
